...
public class RadioSliderGUI extends JPanel
{
    ...
    private void buildSliders( Container parent )
    {
        ...
        ySlider = new JSlider( JSlider.VERTICAL, 0, 500, 0 );
        addLabels( ySlider, 100 );
        ySlider.setBorder( new LineBorder( Color.BLACK, 2 ) );
        ySlider.setValue(_initY);
        ...
        //////////////////////////////////////////////////////////////
        JSlider sSlider = new JSlider( JSlider.VERTICAL, 0, 200, _initSize );
        addLabels( sSlider, 50 );
        ySlider.setBorder( new LineBorder( Color.BLACK, 2 ) );
        ySlider.setValue(_initSize);
        
        SliderListener sListen = new SliderListener( sSlider, "s" );
    ...
    public class SliderListener implements ChangeListener
    {
        ...
        public void stateChanged( ChangeEvent ev )
        {
            ...
            //////////////////////////////////////////////////////////
                ...
                _target.setLocation(_target.getLocation().x, _slider.getValue());
                _target.getParent().repaint();
            }
    ...
    {        
        ...
        for ( int i = 0; i < labels.length; i++ )
        {
            ...
            ButtonListener bListen =  new ButtonListener( color[ i ] );
